...
gameName2 = '강화게임'
weaponName = [
    "롱소드", "롱해머", "듀얼소드", "듀얼스피어", "스태프", "배틀사이드", "블래스터", "활", "크로스건", "카타마르", "그레이트소드", "배틀글레이브", "팬텀대거", "바스타드소드", "마나리볼버", "호미", "낫", "삽", "젓가락", "숟가락", "포크", "단검", "여의봉", "빨대", "수리검", "레이피어", "트라이던트", "카타나", "너클", "채찍"
]

failText    = [
    '어이쿠, 손이 미끄러졌군.', '이런, 이거 미안해서 어쩌나.', '미안하군, 그래도 나름 유명한 대장장이일세.',
    '그래도 옆동네처럼 무색큐브가 나오진 않는다네.', '허허, 이거 미안해서 어쩌나.', '내 그만 손이 미끄러지고 말았구려.',
]
we_N = 1.12
up_N = 1.001
up_V = 100 #비용value
