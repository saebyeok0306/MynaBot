...
class Papago(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.bot = bot
        self.support_langs = {
            'af': False, 'am': False, 'an': False, 'ar': False, 'as': False, 'az': False, 'be': False, 'bg': False, 'bn': False, 'br': False, 'bs': False, 'ca': False, 'cs': False, 'cy': False, 'da': False, 'de': '독일어', 'dz': False, 'el': False, 'en': '영어', 'eo': False, 'es': '스페인어', 'et': False, 'eu': False, 'fa': False, 'fi': False, 'fo': False, 'fr': '프랑스어', 'ga': False, 'gl': False, 'gu': False, 'he': False, 'hi': False, 'hr': False, 'ht': False, 'hu': False, 'hy': False, 'id': '인도네시아어', 'is': False, 'it': '이탈리아어', 'ja': '일본어', 'jv': False, 'ka': False, 'kk': False, 'km': False, 'kn': False, 'ko': '한국어', 'ku': False, 'ky': False, 'la': False, 'lb': False, 'lo': False, 'lt': False, 'lv': False, 'mg': False, 'mk': False, 'ml': False, 'mn': False, 'mr': False, 'ms': False, 'mt': False, 'nb': False, 'ne': False, 'nl': False, 'nn': False, 'no': False, 'oc': False, 'or': False, 'pa': False, 'pl': False, 'ps': False, 'pt': False, 'qu': False, 'ro': False, 'ru': '러시아어', 'rw': False, 'se': False, 'si': False, 'sk': False, 'sl': False, 'sq': False, 'sr': False, 'sv': False, 'sw': False, 'ta': False, 'te': False, 'th': '태국어', 'tl': False, 'tr': False, 'ug': False, 'uk': False, 'ur': False, 'vi': '베트남어', 'vo': False, 'wa': False, 'xh': False, 'zh': '중국어', 'zu': False
        }
